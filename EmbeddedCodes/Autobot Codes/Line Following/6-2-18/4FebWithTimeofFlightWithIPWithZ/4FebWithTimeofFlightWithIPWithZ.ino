...
//calibrated values of 5th Feb
int sensorMinLeft[numOfSensors] = {1459, 1488, 1443, 1147, 1085, 623, 629, 623}; 
int sensorMaxLeft[numOfSensors] = {2984, 2984, 2984, 2956, 2909, 1287, 1380, 2560}; 
int sensorMinRight[numOfSensors] = {2526, 1812, 1840, 1018, 890, 1212, 640, 1806}; 
int sensorMaxRight[numOfSensors] = {2994, 2979, 2986, 2966, 2918, 2976, 2137, 2975}; 
int sensorMinFront[numOfSensors] = {2057, 1435, 1041, 1081, 615, 706, 796, 1651}; 
int sensorMaxFront[numOfSensors] = {3130, 3044, 2888, 2948, 1508, 2775, 2831, 3051}; 
int sensorMinBack[numOfSensors] = {1948, 649, 1031, 1104, 644, 589, 1513, 1343}; 
int sensorMaxBack[numOfSensors] = {2992, 2724, 2952, 2981, 2468, 2300, 3023, 2880};
...
int32_t distance = 0, minDistanceThreshold = 240, maxDistanceThreshold = 370;   //for VL53L0X
...
void throwAtTZ(int zone)
{
  ...
  if(zone == 1)
  {
    ...
    while(bit_is_set(PIND,6))
    {
      ...
      if(ticks >= 268 && throwCount >= 3)   //==158 3 
      {
  ...
  else if(zone == 2)
  {
    ...
    while(bit_is_set(PIND,6))
    {
      ...
      if((ticks >= 266) && throwCount >= 3)   //161 3
      {
        Serial.print("finalticks : ");
        Serial.println(ticks);
