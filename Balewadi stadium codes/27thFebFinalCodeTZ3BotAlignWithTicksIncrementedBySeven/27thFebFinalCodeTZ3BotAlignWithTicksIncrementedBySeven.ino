...
int maxPWM = 666, alignMaxPWM = 220, fastMaxPWM = 666, slowAlignPWM = 175, mediumAlignPWM = 360, botAlignPWM = 100, rampSlowestPWM = 130;
...
int maxAlignCount = 4;
int TZ1Ticks = -223, TZ2Ticks = -216, TZ3Ticks = -206 ;    //-228, -215, -211
...
//   PORTC = 0x00;
   ...
   while(bit_is_set(PING,0))
   {
     ...
     Serial.print("  slow = ");Serial.print(slowAlignPWM);
     Serial.println("");
