...
int sensorMinFront[numOfSensors] = {286, 1344, 1139, 1300, 711, 1053, 1061, 1926};
int sensorMaxFront[numOfSensors] = {2429, 2912, 2834, 2050, 1587, 2343, 2152, 2895};
...
//
int maxAlignCount = 4;
int TZ1Ticks = -232, TZ2Ticks = -215, TZ3Ticks = -215;    //-228, -215, -213
int TZ1ThrowCount = 3, TZ2ThrowCount = 5, TZ3ThrowCount = 5;    //2 4 5
int throwPWM1 = 255, throwPWM2 = 200, throwPWM3 = 195;    //255 215 180
int allBreak = false;
