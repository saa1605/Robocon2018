...
//int sensorMaxBack[numOfSensors] = {2896, 2896, 2628, 1568, 2645, 2893, 2806, 2872};
//int sensorMaxLeft[numOfSensors] = {2378, 2879, 2838, 2879, 2742, 2522, 2873, 2874};
//int sensorMaxFront[numOfSensors] = {2429, 2912, 2834, 2050, 1587, 2343, 2152, 2895};
//int sensorMaxRight[numOfSensors] = {2892, 2891, 2892, 2892, 2876, 2877, 2494, 2763};
//
//
//int sensorMinFront[numOfSensors] = {299, 1542, 1506, 1300, 1048, 1305, 1009, 2281};
//int sensorMinBack[numOfSensors] = {2651, 2120, 1521, 311, 1524, 1870, 1737, 1886};
//int sensorMinRight[numOfSensors] = {1966, 2152, 2342, 2218, 2237, 2167, 1466, 1922};
//int sensorMinLeft[numOfSensors] = {1215, 2139, 1783, 2068, 1645, 1209, 1964, 2315};

//calibrated in the stadium
int sensorMinFront[numOfSensors] = {283, 1476, 1438, 1242, 1038, 1324, 1096, 1880};

//int sensorMinBack[numOfSensors] = {2334, 2692, 1810, 281, 1244, 1559, 1447, 1424};
...
//int sensorMaxBack[numOfSensors] = {2892, 2892, 2891, 2424, 2894, 2895, 2894, 2895};
