...
int sensorMinFront[numOfSensors] = {2185, 2261, 1660, 2007, 1863, 1705, 1933, 2178};
int sensorMinBack[numOfSensors] = {2526, 1018, 543, 911, 1741, 214, 423, 1858};
int sensorMinRight[numOfSensors] = {1876, 2012, 2244, 2171, 2187, 2115, 1594, 2100};
int sensorMinLeft[numOfSensors] = {1003, 1959, 1709, 1981, 1621, 1350, 1917, 2237};
int sensorMaxFront[numOfSensors] = {2917, 2916, 2915, 2915, 2914, 2909, 2911, 2910};
int sensorMaxBack[numOfSensors] = {2897, 2896, 2699, 2876, 2912, 2182, 2766, 2914};
int sensorMaxRight[numOfSensors] = {2897, 2897, 2898, 2898, 2882, 2883, 2885, 2885};
int sensorMaxLeft[numOfSensors] = {2888, 2888, 2887, 2887, 2863, 2864, 2862, 2863};
