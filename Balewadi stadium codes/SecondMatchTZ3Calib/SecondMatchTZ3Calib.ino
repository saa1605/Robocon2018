...
//int sensorMinBack[numOfSensors] = {2033, 1456, 915, 272, 908, 1264, 1269, 1447};
//int sensorMaxBack[numOfSensors] = {2896, 2896, 2628, 1568, 2645, 2893, 2806, 2872};
//
//int sensorMinLeft[numOfSensors] = {521, 1469, 1317, 1352, 1051, 851, 1445, 1768};
//int sensorMaxLeft[numOfSensors] = {2378, 2879, 2838, 2879, 2742, 2522, 2873, 2874};
//
//int sensorMinFront[numOfSensors] = {286, 1344, 1139, 937, 711, 1053, 1061, 1926};
//int sensorMaxFront[numOfSensors] = {2429, 2912, 2834, 2050, 1587, 2343, 2152, 2895};
//
//int sensorMinRight[numOfSensors] = {1719, 1816, 2011, 1838, 1850, 1921, 1487, 1964};
//int sensorMaxRight[numOfSensors] = {2892, 2891, 2892, 2892, 2876, 2877, 2494, 2763};
