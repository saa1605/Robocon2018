...
int sensorMinFront[numOfSensors] = {2098, 1494, 1422, 1855, 652, 1228, 590, 2292};
...
int maxPWM = 666, alignMaxPWM = 220, fastMaxPWM = 620, slowAlignPWM = 140, mediumAlignPWM = 320, botAlignPWM = 100, rampSlowestPWM = 110;
...
int32_t distance = 0, minDistanceThreshold = 172, maxDistanceThreshold = 245;   //for VL53L0X (TOF)
...
int maxAlignCount = 4;
int TZ1Ticks = -230, TZ2Ticks = -222, TZ3Ticks = -213 ;    //-228, -215, -211
