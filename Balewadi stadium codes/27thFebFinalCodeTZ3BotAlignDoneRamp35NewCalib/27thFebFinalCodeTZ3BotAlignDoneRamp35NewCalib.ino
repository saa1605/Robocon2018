...
int maxPWM = 666, alignMaxPWM = 220, fastMaxPWM = 350, slowAlignPWM = 190, mediumAlignPWM = 330, botAlignPWM = 100, rampSlowestPWM = 130;
...
{
  calcAllError();
  while(sensorValLeft[3] < onlineThresh || sensorValLeft[4] < onlineThresh)
  {
    calcAllError();
    bot_spot_left();
  }  
