...
//Calibrated values 27th feb
int sensorMinRight[numOfSensors] = {1857, 1937, 2103, 1925, 1899, 1905, 1443, 1978};
int sensorMaxRight[numOfSensors] = {2628, 2814, 2948, 2743, 2764, 2865, 2296, 2660};
//int sensorMinFront[numOfSensors] = {2150, 2150, 1422, 1855, 652, 1228, 590, 2292};
//int sensorMaxFront[numOfSensors] = {3003, 2708, 2643, 3010, 1411, 2256, 1320, 2848};

int sensorMinFront[numOfSensors] = {673, 1666, 1474, 1189, 973, 1352, 1348, 2233};
int sensorMaxFront[numOfSensors] = {1916, 2907, 2906, 2836, 2646, 2890, 2889, 2890};
//
//int sensorMinLeft[numOfSensors] = {697, 1447, 1058, 1120, 787, 653, 1328, 1604};
//int sensorMaxLeft[numOfSensors] = {2221, 2806, 2552, 2602, 2443, 1850, 2554, 2661};

int sensorMinLeft[numOfSensors] = {1126, 2082, 1699, 1776, 1453, 1346, 1944, 2268};
int sensorMaxLeft[numOfSensors] = {2880, 2881, 2880, 2880, 2874, 2873, 2873, 2874};

int sensorMinBack[numOfSensors] = {2191, 1207, 848, 1185, 1679, 1023, 1769, 668};
int sensorMaxBack[numOfSensors] = {3070, 2301, 2339, 2699, 2798, 2205, 2602, 1692};


int maxPWM = 666, alignMaxPWM = 220, fastMaxPWM = 666, slowAlignPWM = 190, mediumAlignPWM = 350, botAlignPWM = 100, rampSlowestPWM = 130;
...
int32_t distance = 0, minDistanceThreshold = 155, maxDistanceThreshold = 210;   //for VL53L0X (TOF)
...
int maxAlignCount = 4;
int TZ1Ticks = -230, TZ2Ticks = -223, TZ3Ticks = -215 ;    //-228, -215, -213
