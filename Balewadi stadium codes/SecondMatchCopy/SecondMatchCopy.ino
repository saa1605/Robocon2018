...
//
int maxAlignCount = 4;
int TZ1Ticks = -232, TZ2Ticks = -227, TZ3Ticks = -215;    //-228, -215, -213
int TZ1ThrowCount = 3, TZ2ThrowCount = 4, TZ3ThrowCount = 5;    //2 4 5
int throwPWM1 = 255, throwPWM2 = 255, throwPWM3 = 195;    //255 215 180
int allBreak = false;
...
//    alignToLineFollow();  
    ...
    while(1)
    {
      ...
      else if(juncCount == 1 && turnFlag == 1)
      {
        botKill();
        rongBay = 1;
        botAlign(turnFlag);
